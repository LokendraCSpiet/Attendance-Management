...
<body>
    ...
    <header>
      ...
      <h1>FYP-Online Attendance Management System</h1>
      <div class="navbar">
...
--->
      ...
      <div class="form-group">
          ...
          <div class="col-sm-7">
            <input type="text" name="st_batch"  class="form-control" id="input1" placeholder="batch e.x B" />
          </div>
      </div>
      ...
      <div class="form-group">
          ...
          <div class="col-sm-7">
            <input type="text" name="st_sem"  class="form-control" id="input1" placeholder="semester ex. 8th" />
          </div>
      </div>
