...
<header>
  ...
  <h1>FYP-Attendance Management System</h1>
  <div class="navbar">
...
?>
  <strong>
  <p style="text-align: left;">Hi there!<br>You requested for a password recovery. You may <a href="alogin.php">Login here</a> and enter this key as your password to login. Recovery key: <mark><?php echo $dat['password']; ?></mark><br>Regards,<br>FYP-Attendance Management System</p></strong>
<?php
      }
          }
  }
